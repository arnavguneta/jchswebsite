...
jQuery(document).ready(function($) {
    ...
    if ($('.special_tabs').length) {
        $('.special_tabs').each(function(e) {
            ...
            if ($el.find('.tab-container > .content').eq(0).height() > $el.find('.tab-selector').height())
                $el.animate({
                    'height': $el.find('.tab-container > .content').eq(0).height()
                }, 1000, 'easeInOutExpo');
            else $(this).parents('.special_tabs').animate({
                'height': $(this).parents('.tab-selector').height()
            }, 1000, 'easeInOutExpo');
                ...
                $(this).click(function() {
                    if (!$(this).hasClass('current')) {
                        ...
                        if ($nextEl.height() > $(this).parents('.tab-selector').height())
                            $(this).parents('.special_tabs').stop().animate({
                        ...
                        id = id[1];
                        $('.' + elm).find('.tab-selector > .label.' + id).css({
                            'color': '#5c5c5c'
                        });
                        $('.' + elm).find('.tab-selector > .label.' + id + '.current').css({
                            'color': '#5c5c5c'
                        });
                        ...
                        $('.' + elm).find('.tab-selector > .label.' + randid).css({
                            'color': $('').html()
                        });
                        ...
                        $('.' + elm).find('.tab-container > .content.' + randid).addClass('current').stop().animate({
                            'margin-top': '0%',
                            opacity: 1
                        }, 1000, 'easeInOutExpo', function() {
    ...
    if ($('#contact_form').length) {
        ...
        $('#contact_form .service select').change(function() {
            $('#contact_form .service-input').val($('#contact_form .service').val());
        });
    }
    if (window.BrowserDetect.browser === "Explorer" && window.BrowserDetect.version < 10) {
...
(function(e) {
    ...
    e.Isotope.prototype._getMasonryGutterColumns = function() {
        ...
        this.masonry.columnWidth = this.options.masonry && this.options.masonry.columnWidth || this.$filteredAtoms.outerWidth(true) || t;
...
function parallaxInit() {
    if (!isMobile.any()) {
        ...
        if ($('.parallax').length || $('#parallax-home').length) $.stellar({
            responsive: true,
